...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-custom mb-4">
        <div class="container">
            ...
            <div class="d-flex">
                <a href="view_patients.php" class="btn btn-outline-light btn-sm">Back to Dashboard</a>
            </div>
        </div>
    </nav>
    ...
    <div class="container mt-3">
        <?php if ($_GET['msg'] == 'sms_sent'): ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Success!</strong> Medication reminder sent.
    ...
    <div class="container">
        <div class="row mb-3 align-items-center">
            <div class="col-md-6">
                ...
                <p class="text-muted">ID: PLH-<?php echo htmlspecialchars($patient['id']); ?></p>
            </div>
            ...
            <div class="col-md-6 text-end">
                ...
                <form action="send_sms.php" method="POST" style="display: inline;">
                    <input type="hidden" name="patient_id" value="<?php echo $patient['id']; ?>">
                    <button type="submit" class="btn btn-primary">Send Reminder (SMS)</button>
                </form>
